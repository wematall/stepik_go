# stepik_go
в репозитории решения задач из курса "Программирование на Golang"
...
64. task_64 to do
### 3.8 Threads 1
65. task_65 Напишите функцию (принимает канал и число)
66. task_66 Напишите функцию (принимает канал и строку)
67. task_67 Напишите функцию (принимает два канала)
### 3.9 Threads 2
68. task_68 в гоурутине вызвать функцию
69. task_69 вызвать функцию в отдельных гоурутинах 10 раз
70. task_70 to do
71. task_71 to do
72. task_72 to do
